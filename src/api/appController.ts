...
/** 管理员根据 id 获取应用详情 管理员根据 id 获取应用详情 GET /app/admin/get/vo */
...
/** 管理员分页获取应用列表 管理员分页获取应用列表 POST /app/admin/list/page/vo */
...
/** 应用聊天生成代码（流式 SSE） 应用聊天生成代码（流式 SSE） GET /app/chat/gen/code */
...
/** 删除应用（用户只能删除自己的应用） 删除应用（用户只能删除自己的应用） POST /app/delete */
...
/** 根据 id 获取应用详情 根据 id 获取应用详情 GET /app/get/vo */
...
/** 分页获取当前用户创建的应用列表 分页获取当前用户创建的应用列表 POST /app/my/list/page/vo */
...
/** 更新应用（用户只能更新自己的应用名称） 更新应用（用户只能更新自己的应用名称） POST /app/update */
