...
/** 添加用户（仅管理员） 添加用户（仅管理员） POST /user/add */
...
/** 删除用户（仅管理员） 删除用户（仅管理员） POST /user/delete */
...
/** 根据 id 获取用户（仅管理员） 根据 id 获取用户（仅管理员） GET /user/get */
...
/** 根据 id 获取包装类 根据 id 获取包装类 GET /user/get/vo */
...
/** 根据主键获取用户。 根据主键获取用户。 GET /user/getInfo/${param0} */
...
/** 分页获取用户封装列表（仅管理员） 分页获取用户封装列表（仅管理员） POST /user/list/page/vo */
...
/** 根据主键删除用户。 根据主键删除用户。 DELETE /user/remove/${param0} */
...
/** 根据主键更新用户。 根据主键更新用户。 PUT /user/update */
...
/** 更新用户（仅管理员） 更新用户（仅管理员） POST /user/update */
