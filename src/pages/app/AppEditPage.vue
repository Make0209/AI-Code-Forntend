<template>
  <div id="appEditPage" :class="{ 'is-dark': isDarkMode }">
...
// 进入对话页面
const goToChat = () => {
  if (appInfo.value?.id) router.push(`/app/chat/${appInfo.value.id}`)
}
...
.is-dark :deep(.ant-card) {
  background: #1f1f1f;
  border-color: #303030;
}

.is-dark :deep(.ant-card-head) {
  background: #2a2a2a;
  border-bottom-color: #303030;
  color: rgba(255, 255, 255, 0.88);
}

.is-dark :deep(.ant-card-body) {
  background: #1f1f1f;
}
...
.is-dark :deep(.ant-form-item-extra) {
  color: rgba(255, 255, 255, 0.35);
}
...
.is-dark :deep(.ant-descriptions-bordered .ant-descriptions-item-label) {
  background: #2a2a2a;
  color: rgba(255, 255, 255, 0.65);
  border-color: #303030;
}

.is-dark :deep(.ant-descriptions-bordered .ant-descriptions-item-content) {
  background: #1f1f1f;
  color: rgba(255, 255, 255, 0.85);
  border-color: #303030;
}

.is-dark :deep(.ant-descriptions-bordered) {
  border-color: #303030;
}

.is-dark :deep(.ant-descriptions-row) {
  border-bottom-color: #303030;
}
</style>
